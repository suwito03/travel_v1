...
$config['admin_email']                = "suwito03@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'agent';              // Default group, use name
$config['staff_bst_group']            = 'staff';              // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['agent_group']                = 'agent';             // Default agent group, use name
$config['ceo_group']                  = 'ceo';               // Default ceo group, use name
