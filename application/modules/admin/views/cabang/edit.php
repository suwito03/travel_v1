...
<div class="container-fluid">
    <form id='frmaddpaket' method='post' accept-charset='utf-8' enctype='multipart/form-data' action="<?=site_url('admin/cabang/update')?>" onsubmit="return validateForm()">
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Edit Lokasi Lokasi</div>
                <div class="panel-body">
                <div class="form-horizontal">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label">Kantor Pusat</label>
                                <div class="col-sm-3">
                                    <select  id="cmbpilpusat" name="cmbpilpusat" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="txtnama" name="txtnama" required value="<?php echo $edit[0]['nama'];?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">PIC</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="txtpic" name="txtpic" required value="<?php echo $edit[0]['pic'];?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">PIC Mobile</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="txtpichp" name="txtpichp" required value="<?php echo $edit[0]['pic_hp'];?>">
                                    </div>
                                </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label">Telepon</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="txttlp" name="txttlp" required value="<?php echo $edit[0]['telepon'];?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label">Email</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="txtemail" name="txtemail" required value="<?php echo $edit[0]['email'];?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label">Alamat</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="txtalamat" name="txtalamat" required value="<?php echo $edit[0]['alamat'];?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                         <button type="submit" class="btn btn-primary col-sm-3" style="margin-right: 5px;">Update</button>
                                         <button type="cancel" class="btn btn-dark col-sm-3" onclick="canceladd()">Cancel</button>
                                         <input type="hidden" class="form-control" id="txtidlokasi" name="txtidlokasi"  value="<?php echo $idlokasi;?>">
                                </div>
                            </div>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    // load data from edit
    $("#cmbpilpusat").val("<?php echo $edit[0]['ispusat'];?>");
    $("#jqxcmbprovinsi").jqxComboBox('selectItem', '<?php echo $edit[0]['id_provinsi'];?>');
    $("#jqxcmbkabupaten").jqxComboBox('selectItem', '<?php echo $edit[0]['id_kabupaten'];?>');
    $("#jqxcmbkecamatan").jqxComboBox('selectItem', '<?php echo $edit[0]['id_kecamatan'];?>');
    $("#jqxcmbkelurahan").jqxComboBox('selectItem', '<?php echo $edit[0]['id_kelurahan'];?>');
