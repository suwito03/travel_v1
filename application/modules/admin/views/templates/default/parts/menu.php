...
<!--                    </li>-->
            ...
            <li class="treeview">
                <a href="#">
                    ...
                    <span>Pengaturan Aplikasi</span><i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <!--<li class="treeview">-->
                    ...
                    <li class="treeview">
                        <a href="<?php echo site_url('admin/user_groups/'); ?>">
                            <i class="fa fa-edit"></i> <span>Pengaturan Hak Pengguna</span>
                        </a>
                    </li>
                    ...
                    <?php } ?>
                     <li class="treeview">
                        <a href="<?php echo site_url('admin/user/attempts/'); ?>">
                            <i class="fa fa-edit"></i> <span>Percobaan Login</span>
                        </a>
                    </li>
                </ul>
            </li>
