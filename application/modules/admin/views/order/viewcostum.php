    ...
    <div class="modal-dialog  modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Detail Informasi Kostum Paket Umroh</h5>
            </div>
...
$(document).ready(function () {
    ...
    var calendar = $('#calendar').fullCalendar({
        ...
        events: "<?=site_url('admin/json/render_event_order_costum'); ?>",
...
function loaddetail(id) {
   ...
   $('.addtdmain').remove();
    $.ajax({
        type: "POST",
        url: '<?=base_url('admin/json/getdtpaket_umroh_costum'); ?>/'+idstr[1],
