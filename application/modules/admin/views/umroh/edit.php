...
<div class="container-fluid">
    <form id='frmaddpaket' method='post' accept-charset='utf-8' enctype='multipart/form-data' action="<?=site_url('admin/umroh/update')?>" onsubmit="return validateForm()">
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Edit Paket Umroh</div>
                <div class="panel-body">
                    <div class="form-horizontal">
                        <div class="form-group">
                            <label for="exampleInputName2" class="col-sm-1 control-label">Paket</label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control" id="txtnama" name="txtnama" value="<?php echo $edit[0]['name'];?>">
                                <input type="hidden" class="form-control" id="txtcodepaket" name="txtcodepaket" value="<?php echo $kodepaket;?>">
                                <input type="hidden" class="form-control" id="txtidpaket" name="txtidpaket" value="<?php echo $idpaket;?>">
                            </div>
                            <label for="exampleInputName2" class="col-sm-1 control-label">Jenis</label>
                            <div class="col-sm-2">
                                <select  id="txtcmbjenis" name="txtcmbjenis" class="form-control">
                                        <option value="9">Paket 9 Hari</option>
                                        <option value="12">Paket 12 Hari</option>
                                        <option value="15">Paket 15 Hari</option>
                                </select>
                            </div>
                            <label for="exampleInputEmail2" class="col-sm-1 control-label">Harga</label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control money" id="txthrg" name="txthrg" value="<?php echo $edit[0]['price'];?>" onkeyup="this.value=this.value.replace(/[^\d]/,'')">
                            </div>
...
function canceladd() {
    window.location.href = '<?php echo site_url("admin/umroh/");?>';
}
$(function(){
