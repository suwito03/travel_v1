...
class Reffinclude_costum_model extends CI_Model
{

    public $_table = 'reff_include_costum';
    ...
    public function existitem($idinclude, $idpackage)
    {
        $query = $this->db->select('*')
            ->from($this->_table)
            ->where('idinclude', $idinclude)
