...
class Umroh_costum_jamaah_model extends CI_Model
{

    public $_table = 'costumumroh_jamaah';
    ...
    public function existitem($idorder,$idpackage,$idjamaah)
    {
    ...
    // check maximal qouta jemaah
    public function checkqouta($idorder,$idagent,$maxjamaah)
    {
        $query = $this->db->select('*')
            ->from($this->_table)
            ->where('idorder', $idorder)
