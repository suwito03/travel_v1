...
<div class="container-fluid">
    <form id='frmaddpaket' method='post' accept-charset='utf-8' enctype='multipart/form-data' action="<?=site_url('admin/umroh/save')?>" onsubmit="return validateForm()">
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Paket Umroh</div>
                <div class="panel-body">
                    <div class="form-horizontal">
                        <div class="form-group">
                            <label for="exampleInputName1" class="col-sm-1 control-label">Paket</label>
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control money" id="txthrg" name="txthrg" onkeyup="this.value=this.value.replace(/[^\d]/,'')">
                            </div>
