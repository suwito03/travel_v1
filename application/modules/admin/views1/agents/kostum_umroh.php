...
<div class="container-fluid">
    <form id='frmcostum' method='post' accept-charset='utf-8' enctype='multipart/form-data' action="<?=site_url('admin/agents/save_costum')?>" onsubmit="return validateForm()">
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="txtnamabasis" name="txtnamabasis" value="<?php echo $edit[0]['name'];?>" disabled>
                                <input type="hidden" class="form-control" id="tglbook" name="tglbook" value="<?php echo $tglbook;?>" >
                                <input type="hidden" class="form-control" id="txtnama" name="txtnama" value="<?php echo $edit[0]['name'];?>" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1">
                                <input type="text" class="form-control money" id="txtjmlh" name="txtjmlh" onkeyup="this.value=this.value.replace(/[^\d]/,'')">
                            </div>
                            <button type="submit" class="btn btn-primary col-sm-1" style="margin-right: 5px;">Proses</button>
