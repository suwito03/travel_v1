                        ...
                        <div class="card-body table-responsive">
                         ...
                         <div class="card-footer">
                                <button type="button" class="btn btn-info btn-rounded" onclick="gotoview()">
                                  <i class="fa fa-calendar"></i> Lihat Order Paket Umroh bentuk Kalender
                                </button>
...
<script type="text/javascript">
 $(document).ready(function () {
     ...
     var headersource =
     {
         ...
         url: '<?=base_url('admin/json/getdataorder_agent'); ?>',
         id: 'idorder',
         async: false
     };
     ...
     $("#jqxgrid").jqxGrid(
             {
                 ...
                 columns: [
                     ...
                     {
                         text: '',columngroup:'bayar',filtertype: 'none', width: 155, cellsalign: 'right',columntype:'button',cellsclass:'btn btn-info',
                         cellsrenderer: function (row, column, value) {
                             var grid = $('#' + this.owner.element.id);
                             var rowData = grid.jqxGrid('getrowdata', row);
                             if (rowData.islunas==1 || rowData.status==2) {
