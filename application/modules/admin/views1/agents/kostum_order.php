    ...
    <div class="modal fade" id="modalConfirmBayar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id='frmaddbayar' method='post' accept-charset='utf-8' enctype='multipart/form-data' action="<?=site_url('admin/agents/savebayarcostum')?>" onsubmit="return validateForm()">
                    <div class="modal-body">
                        <div class="form-group row">
...
<script type="text/javascript">
                 ...
                 columns: [
                     ...
                     { text: 'No Pasport', datafield: 'no_pasport',width: 160},
                     {
                         text: '', columngroup:'vendor',filtertype: 'none', width: 90, cellsalign: 'right',columntype:'button',cellsclass:'btn btn-info', cellsrenderer: function () {
                             ...
                             bootbox.confirm({
                                 message: "Apa anda yakin ingin menhapus data jamaah ini.!!?",
                                 buttons: {
                                     confirm: {
                                         label: 'Ya',
                                 ...
                                 callback: function (result) {
                                     if (result) {
                                         window.location.href = '<?php echo site_url("admin/agents/deldtjamaah_costum");?>/'+rowData.idreff;
                                     }
                                 }
                             });
     ...
     $("#jqxgrid").jqxGrid(
             {
                 ...
                 columns: [
                     ...
                     //     }
                     // },
                     { text: 'Status',columngroup:'status',  columntype: 'textbox', filtertype: 'list',datafield: 'statusorder',align: 'center',width: '140',cellsalign: 'center' },
 ...
 $(function(){
     $("#frmaddjamaah").submit(function(){
         ...
         $.ajax({
             type: "POST",
             url: '<?=base_url('admin/agents/savejamaah_costum/'); ?>',
             data: dataString,
