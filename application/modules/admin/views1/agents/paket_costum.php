                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <button type="button" class="btn btn-info btn-rounded" onclick="gotoview()">
                                <i class="fa fa-calendar"></i> Lihat Jadwal Kostum Paket Umroh Bentuk Kalendar
                            </button>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
        ...
        var headersource =
            {
                ...
                url: '<?=base_url('admin/json/getdatapaket_umroh_costum_agent'); ?>',
                id: 'idpackage',
                async: false
            };
        ...
        var sourcefinish =
            {
                ...
                url: '<?=base_url('admin/json/getdatapaket_umroh_costum_finish_agent'); ?>',
                id: 'idpackage',
                async: false
            };
        ...
        $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'Harga per Jamaah',columntype: 'numberinput',columngroup:'status', filtertype: 'numberinput',cellsformat: 'c0',datafield: 'price',align: 'center',cellsalign: 'right',width: '155'},
                    ...
                    {
                        text: '', columngroup:'action', filtertype: 'none', width: 75, cellsalign: 'right',columntype:'button',cellsclass:'btn btn-info fa fa-plus-circle', cellsrenderer:
                            ...
                            var rowData = grid.jqxGrid('getrowdata', row)
                            if (rowData.status == 1) {
                                window.location.href = '<?php echo site_url("admin/agents/editcostum");?>/'+rowData.idpackage;
                            } else if (rowData.status == 2) {
                               // bootbox.alert('Data kostum paket  umroh tidak bisa diedit lagi<br> Data telah diproses dan direview oleh admin.!');
                                bootbox.confirm({
                                    message: "Apa anda yakin ingin deal harga kostum paket umroh ini.!!!?<br>Tekan <b>Ya</b> jika setuju data akan di proses menjadi order.<br>Silahkan cek menu data order kostum paket umroh.",
                                    buttons: {
                                        confirm: {
                                            label: 'Ya',
                                    ...
                                    callback: function (result) {
                                        if (result) {
                                            window.location.href = '<?php echo site_url("admin/agents/convert_order");?>/'+rowData.idpackage +'/'+rowData.price;
                                        }
                                    }
                                });
                            }
    ...
    function gotoview(){
        window.location.href = '<?php echo site_url("admin/agents/viewcostum");?>';
    }
</script>