...
if ( $all ) {
	...
	foreach ( $all as $value ) {
        ...
        $row[] = "<td style='text-align:center;'><a data-toggle='tooltip' class='btn btn-primary btn-xs edit'  id='" . $id . "' title='Edit'> <i class='fa fa-pencil-square-o'></i> </a>
				  <a data-toggle='tooltip' class='btn btn-danger btn-xs  delete'  id='" . $id . "' title='Delete'> <i class='fa fa-trash-o'></i> </a></td></tr> <a data-toggle='tooltip' class='btn btn-success btn-xs  reset'  id='" . $id . "' title='Reset'>Reset Password</a></td></tr>";
