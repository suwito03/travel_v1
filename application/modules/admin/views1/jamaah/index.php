...
<div class="row" id="bodygrid">
        <div class="col-md-12">
            ...
            <div class="card-footer">
                ...
                <button type="button" class="btn btn-success btn-rounded" onclick="exportexcel()">
...
<script type="text/javascript">
 $(document).ready(function () {
     ...
     var headersource =
     {
         ...
         url: '<?=base_url('admin/json/getdt_jamaah_byagent'); ?>',
         id: 'idjamaah',
         async: false
     };
    ...
    //grid master
     ...
     function exportexcel() {
         $("#jqxgrid").jqxGrid('exportdata', 'xls', 'export_jamaah');
     }
