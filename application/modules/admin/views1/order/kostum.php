        ...
        var headersource =
            {
                ...
                url: '<?=base_url('admin/json/getdataorder_costum'); ?>',
                id: 'idorder',
                async: false
            };
                        ...
                        cellsrenderer: function (row, column, value) {
                            ...
                            if (rowData.status <= 0  && rowData.islunas == false) {
                                bootbox.confirm({
                                    ...
                                    callback: function (result) {
                                        if (result) {
                                            window.location.href = '<?php echo site_url("admin/order/konfirmasi_costum");?>/'+rowData.idorder+'/'+rowData.idqouta;
                                        }
                                    }
                                });
                            } else if (rowData.islunas == true) {
                                bootbox.confirm({
                                    ...
                                    callback: function (result) {
                                        if (result) {
                                            window.location.href = '<?php echo site_url("admin/order/konfirmasi_selesai_costum");?>/'+rowData.idorder;
                                        }
                                    }
                                });
                            } else {
                        ...
                        cellsrenderer: function (row, column, value) {
                            ...
                            if (rowData.isdp === true || rowData.islunas === true) {
                                ...
                                bootbox.confirm({
                                    ...
                                    callback: function (result) {
                                        if (result) {
                                            window.location.href = '<?php echo site_url("admin/order/void_costum");?>/'+rowData.idorder;
                                        }
                                    }
                                });
                            }
