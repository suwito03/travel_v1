...
class Ion_auth_model extends CI_Model
{
	...
	{
	    $data = [
	        'password' => '$2y$10$GrBdenHtvWysZNti6XqC.ukQRqkX5TUb8nhWYccT1Bv5AdufzqSL.'
	    ];
	    ...
	    if ($this->db->affected_rows() === 1)
	    {
	        $this->trigger_events(['reset_password', 'reset_password_successful']);
	        $this->set_message('reset_password_successful');
	        return TRUE;
	    }else{
	        $this->set_message('reset_password_failed');
	        return FALSE;
	    }
