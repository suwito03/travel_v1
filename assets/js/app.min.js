...
function _init() {
    ...
    $.AdminLTE.layout = {
        activate: function() {
            var a = this;
            a.fix(), $(window, ".wrapper").resize(function() {
               // a.fix(), a.fixSidebar()
            })
        },
        fix: function() {
            var a = $(".main-header").outerHeight() + $(".main-footer").outerHeight(),
                b = $(window).height(),
                c = $(".sidebar").height();
            if ($("body").hasClass("fixed")) $(".content-wrapper, .right-side").css("min-height", b - $(".main-footer").outerHeight()-11);
            else {
                var d;
                b >= c ? ($(".content-wrapper, .right-side").css("min-height", b - a-11), d = b - a) : ($(".content-wrapper, .right-side").css("min-height", c-11), d = c);
                var e = $($.AdminLTE.options.controlSidebarOptions.selector);
                "undefined" != typeof e && e.height() > d && $(".content-wrapper, .right-side").css("min-height", e.height()-11)
            }
        }
    }, $.AdminLTE.pushMenu = {
        activate: function(a) {
        ...
        _fixForContent: function(a) {
            $(".content-wrapper, .right-side").css("min-height", a.height()-11)
        }
    }, $.AdminLTE.boxWidget = {
